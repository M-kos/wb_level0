...
type Order struct {
	...
	Delivery          Delivery `json:"delivery" validate:"required,required"`
	Payment           Payment  `json:"payment" validate:"required,required"`
	Items             []Item   `json:"items" validate:"required,min=1,dive,required"`
	Locale            string   `json:"locale" validate:"required"`
	InternalSignature string   `json:"internal_signature" validate:"omitempty,min=2"`
...
type Delivery struct {
	...
	Region  string `json:"region" validate:"required,min=2"`
